// src/main/java/com/example/demo/repository/TemperatureRuleRepository.java
...
public interface TemperatureRuleRepository extends JpaRepository<TemperatureRule, Long> {
    ...
    @Query("SELECT r FROM TemperatureRule r WHERE r.productType = :productType AND r.active = true AND :date BETWEEN r.effectiveFrom AND r.effectiveTo")
